...
For full documentation, see [DOCS.md](./shelly-manager/DOCS.md).
...
2. Search for "**Shelly Manager**" in the app store and click "Install".
...
[license-shield]: https://img.shields.io/github/license/hassos-apps/app-shelly-manager.svg
