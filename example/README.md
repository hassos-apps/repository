...
This is a reference implementation that demonstrates the standard app structure,
s6-overlay service pattern, and ecosystem conventions. Use it as a guide when
building your own apps.

For full documentation, see [DOCS.md](./example/DOCS.md).
...
2. Search for "**Example**" in the app store and click "Install".
...
[license-shield]: https://img.shields.io/github/license/hassos-apps/app-example.svg
